     ...
     if(modo == "s"){
        ...
        if (result.isConfirmed) {
            ...
            Swal.fire({
                ...
                html: `<a href="https://api.whatsapp.com/send?phone=+51933308358" target="_blank"><img src="vistas/img/svg/whatsapp.svg" width="90px"></a>`,
                footer: '<a href="https://mipaginaweb.pe/" target="_blank">Mi Página Web</a>'
              })
        $("#sim").addClass("prod");
        $("#sim").html("Producción");
        $("#nom").html("||");
